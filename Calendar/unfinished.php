...
if(isset($_GET['year-month'])) {
	$first = $_GET['year-month'];
} else {
	$first = date('Y-m');
}
$first = strtotime($first, '-01');
    ...
    <div class="custom-calendar-wrap">
        <div class="custom-inner">
            <div class="custom-header clearfix">
                <nav>
                    <a href="?year-month=<?php echo $prev ?>" class="custom-btn custom-prev"></a>
                    <a href="?year-month=<?php echo $next ?>" class="custom-btn custom-next"></a>
                </nav>
